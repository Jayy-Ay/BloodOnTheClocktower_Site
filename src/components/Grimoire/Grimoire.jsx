...
import { GiSkullCrossedBones, GiPoisonBottle, GiJeweledChalice, GiShield, GiBrokenShield, GiDramaMasks, GiPlainDagger, GiDrop, GiHeartBeats } from 'react-icons/gi'
import { FaTimes } from 'react-icons/fa'
import CharacterCard from '../CharacterCard/CharacterCard'
import './Grimoire.css'

const REMINDERS = [
  { id: 'dead', label: 'Dead', color: '#7f8c8d', icon: <GiSkullCrossedBones /> },
  { id: 'poisoned', label: 'Poisoned', color: '#8e44ad', icon: <GiPoisonBottle /> },
  { id: 'drunk', label: 'Drunk', color: '#e74c3c', icon: <GiJeweledChalice /> },
  { id: 'protected', label: 'Protected', color: '#3498db', icon: <GiShield /> },
  { id: 'noability', label: 'No Ability', color: '#95a5a6', icon: <GiBrokenShield /> },
  { id: 'mad', label: 'Mad', color: '#9b59b6', icon: <GiDramaMasks /> },
  { id: 'custom', label: 'Custom', color: '#f39c12', icon: <GiPlainDagger /> },
]
        ...
        <div className="grimoire-circle-container">
          <div className="grimoire-circle">
            ...
            <div className="circle-center">
              <span className="center-icon"><GiDrop /></span>
              ...
              return (
                ...
                >
                  <div className="token-inner">
                    ...
                    {!player.isAlive && <div className="death-shroud"><GiSkullCrossedBones /></div>}
                      ...
                      <div className="token-reminders">
                        {player.reminders.slice(0, 3).map((r, i) => (
                          <span key={i} className="mini-reminder" title={r}>
                            {REMINDERS.find(rem => rem.label === r)?.icon || <GiPlainDagger />}
                          </span>
                        ))}
            ...
            <div className="card panel-section">
              ...
              <div className="player-details">
                ...
                <div className="form-group">
                  ...
                  >
                    {selectedPlayer.isAlive ? <><GiHeartBeats /> Alive</> : <><GiSkullCrossedBones /> Dead</>}
                  </button>
                </div>
